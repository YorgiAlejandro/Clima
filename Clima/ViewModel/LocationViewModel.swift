...
final class LocationViewModel : NSObject, ObservableObject{
    ...
    //Aqui vamos a sobreescribir caracteristicas de locationManager
    override init() {
        ...
        userLocation = .init(center: .init(latitude: DefaultRegion.latitude, longitude: DefaultRegion.longitude), span: .init(latitudeDelta: Span.delta, longitudeDelta: Span.delta)) //Aqui estamos inicializando la localizacion con esta que es por default, si el usuario da su permiso esta location es actualizada con la mas reciente
    }
    ...
    //Obtener una ciudad segun lat y lon
